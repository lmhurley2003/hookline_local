...
bool load_png(std::istream &from, unsigned int *width, unsigned int *height,
              vector<glm::u8vec4> *data, OriginLocation origin);
void save_png(std::ostream &to, unsigned int width, unsigned int height,
...
bool load_png(std::istream &from, unsigned int *width, unsigned int *height,
    ...
    *width = *height = 0;
    ...
    [[maybe_unused]] size_t rowbytes = png_get_rowbytes(png, info);
